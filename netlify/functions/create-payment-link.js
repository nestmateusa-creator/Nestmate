...
console.log('STRIPE_SECRET_KEY starts with:', process.env.STRIPE_SECRET_KEY ? process.env.STRIPE_SECRET_KEY.substring(0, 20) : 'undefined');
  ...
  try {
    ...
    const paymentLink = await stripe.paymentLinks.create({
      ...
      after_completion: {
        type: 'redirect',
        redirect: {
          url: `${event.headers.origin || 'https://www.nestmateus.com'}/payment-confirmation-simple.html?payment=success&plan=${planType}`,
        },
      },
    });
